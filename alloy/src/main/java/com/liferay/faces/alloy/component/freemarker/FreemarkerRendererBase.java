...
public abstract class FreemarkerRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, Freemarker freemarker) throws IOException {
		...
		responseWriter.startElement("script", freemarker);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-freemarker',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var freemarker = new Y.Freemarker");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(freemarker.getDirectives() != null)
		{
			...
			responseWriter.write("directives: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(freemarker.getDirectives().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(freemarker.getDirectivesMatcher() != null)
		{
			...
			responseWriter.write("directivesMatcher: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(freemarker.getDirectivesMatcher().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(freemarker.getHost() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(freemarker.getHost().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(freemarker.getVariables() != null)
		{
			...
			responseWriter.write("variables: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(freemarker.getVariables().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(freemarker.getVariablesMatcher() != null)
		{
			...
			responseWriter.write("variablesMatcher: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(freemarker.getVariablesMatcher().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
