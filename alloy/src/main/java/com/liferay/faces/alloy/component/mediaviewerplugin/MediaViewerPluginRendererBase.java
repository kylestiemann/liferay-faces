...
public abstract class MediaViewerPluginRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, MediaViewerPlugin mediaViewerPlugin) throws IOException {
		...
		responseWriter.startElement("script", mediaViewerPlugin);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-mediaviewerplugin',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var mediaViewerPlugin = new Y.MediaViewerPlugin");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(mediaViewerPlugin.getProviders() != null)
		{
			...
			responseWriter.write("providers: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(mediaViewerPlugin.getProviders().toString());
			responseWriter.write(StringPool.APOSTROPHE);
