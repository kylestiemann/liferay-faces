...
public abstract class TextAreaCellEditorRendererBase extends AUIRenderer {
	...
	protected abstract void encodeHTML(FacesContext facesContext, TextAreaCellEditor textAreaCellEditor) throws IOException;
	...
	protected void encodeJavaScript(FacesContext facesContext, TextAreaCellEditor textAreaCellEditor) throws IOException {
		...
		responseWriter.startElement("script", textAreaCellEditor);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-textareacelleditor',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var textAreaCellEditor = new Y.TextAreaCellEditor");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
