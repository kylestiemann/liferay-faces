...
public abstract class FormBuilderRadioFieldBase extends javax.faces.component.UIPanel {
	...
	protected java.lang.String getFormbuilderradiofieldId() {
		return (java.lang.String) getStateHelper().eval(FORMBUILDERRADIOFIELD_ID, null);
	}

	protected void setFormbuilderradiofieldId(java.lang.String formbuilderradiofieldId) {
	...
	protected java.lang.String getFormbuilderradiofieldParent() {
		return (java.lang.String) getStateHelper().eval(FORMBUILDERRADIOFIELD_PARENT, null);
	}

	protected void setFormbuilderradiofieldParent(java.lang.String formbuilderradiofieldParent) {
