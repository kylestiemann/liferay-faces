...
public abstract class PropertyListBase extends javax.faces.component.UIPanel {
	...
	public static final String BODY_CONFIG = "bodyConfig";
	public static final String BODY_VIEW = "bodyView";
	...
	public static final String FOOTER_CONFIG = "footerConfig";
	...
	public static final String AFTER_AUTO_SYNC_CHANGE = "afterAutoSyncChange";
	public static final String AFTER_BODY_CONFIG_CHANGE = "afterBodyConfigChange";
	public static final String AFTER_BODY_VIEW_CHANGE = "afterBodyViewChange";
	...
	public static final String AFTER_COLUMNSET_CHANGE = "afterColumnsetChange";
	public static final String AFTER_CONTENT_BOX_CHANGE = "afterContentBoxChange";
	public static final String AFTER_DATA_CHANGE = "afterDataChange";
	...
	public static final String AFTER_FOOTER_CONFIG_CHANGE = "afterFooterConfigChange";
	public static final String AFTER_FOOTER_VIEW_CHANGE = "afterFooterViewChange";
	public static final String AFTER_HEADER_CONFIG_CHANGE = "afterHeaderConfigChange";
	...
	public static final String AFTER_RECORD_TYPE_CHANGE = "afterRecordTypeChange";
	public static final String AFTER_RECORDSET_CHANGE = "afterRecordsetChange";
	...
	public static final String AFTER_SORT_BY_CHANGE = "afterSortByChange";
	public static final String AFTER_SORTABLE_CHANGE = "afterSortableChange";
	...
	public static final String AFTER_SUMMARY_CHANGE = "afterSummaryChange";
	public static final String AFTER_TAB_INDEX_CHANGE = "afterTabIndexChange";
	public static final String AFTER_VIEW_CHANGE = "afterViewChange";
	public static final String AFTER_VIEW_CONFIG_CHANGE = "afterViewConfigChange";
	...
	public static final String ON_AUTO_SYNC_CHANGE = "onAutoSyncChange";
	public static final String ON_BODY_CONFIG_CHANGE = "onBodyConfigChange";
	public static final String ON_BODY_VIEW_CHANGE = "onBodyViewChange";
	...
	public static final String ON_COLUMNSET_CHANGE = "onColumnsetChange";
	...
	public static final String ON_FOOTER_CONFIG_CHANGE = "onFooterConfigChange";
	public static final String ON_FOOTER_VIEW_CHANGE = "onFooterViewChange";
	public static final String ON_HEADER_CONFIG_CHANGE = "onHeaderConfigChange";
	...
	public static final String ON_RECORD_TYPE_CHANGE = "onRecordTypeChange";
	public static final String ON_RECORDSET_CHANGE = "onRecordsetChange";
	...
	public static final String ON_SORT_BY_CHANGE = "onSortByChange";
	public static final String ON_SORTABLE_CHANGE = "onSortableChange";
	...
	public static final String ON_SUMMARY_CHANGE = "onSummaryChange";
	public static final String ON_TAB_INDEX_CHANGE = "onTabIndexChange";
	public static final String ON_VIEW_CHANGE = "onViewChange";
	public static final String ON_VIEW_CONFIG_CHANGE = "onViewConfigChange";
