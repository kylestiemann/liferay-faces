...
public abstract class TreeDataRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, TreeData treeData) throws IOException {
		...
		responseWriter.startElement("script", treeData);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-treedata',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var treeData = new Y.TreeData");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(treeData.getTreedataChildren() != null)
		{
			...
			responseWriter.write("treedataChildren: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(treeData.getTreedataChildren().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(treeData.getContainer() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(treeData.getContainer().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(treeData.getIndex() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(treeData.getIndex().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
