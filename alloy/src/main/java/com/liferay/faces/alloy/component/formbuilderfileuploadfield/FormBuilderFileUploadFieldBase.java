...
public abstract class FormBuilderFileUploadFieldBase extends javax.faces.component.UIPanel {
	...
	protected java.lang.String getFormbuilderfileuploadfieldId() {
		return (java.lang.String) getStateHelper().eval(FORMBUILDERFILEUPLOADFIELD_ID, null);
	}

	protected void setFormbuilderfileuploadfieldId(java.lang.String formbuilderfileuploadfieldId) {
	...
	protected java.lang.String getFormbuilderfileuploadfieldParent() {
		return (java.lang.String) getStateHelper().eval(FORMBUILDERFILEUPLOADFIELD_PARENT, null);
	}

	protected void setFormbuilderfileuploadfieldParent(java.lang.String formbuilderfileuploadfieldParent) {
