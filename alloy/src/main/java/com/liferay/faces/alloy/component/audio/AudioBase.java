...
public abstract class AudioBase extends javax.faces.component.UIPanel {
	...
	public static final String SWF_HEIGHT = "swfHeight";
	public static final String SWF_URL = "swfUrl";
	public static final String SWF_WIDTH = "swfWidth";
	...
	public static final String AFTER_OGG_URL_CHANGE = "afterOggUrlChange";
	...
	public static final String AFTER_SWF_HEIGHT_CHANGE = "afterSwfHeightChange";
	public static final String AFTER_SWF_URL_CHANGE = "afterSwfUrlChange";
	public static final String AFTER_SWF_WIDTH_CHANGE = "afterSwfWidthChange";
	...
	public static final String ON_OGG_URL_CHANGE = "onOggUrlChange";
	...
	public static final String ON_SWF_HEIGHT_CHANGE = "onSwfHeightChange";
	public static final String ON_SWF_URL_CHANGE = "onSwfUrlChange";
	public static final String ON_SWF_WIDTH_CHANGE = "onSwfWidthChange";
