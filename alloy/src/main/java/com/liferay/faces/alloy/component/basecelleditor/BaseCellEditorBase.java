 ...
 * @generated
 */
public abstract class BaseCellEditorBase extends javax.faces.component.UIPanel {
	...
	private static final String BASECELLEDITOR_VALUE = "basecelleditorValue";
	...
	protected java.lang.String getBasecelleditorValue() {
		return (java.lang.String) getStateHelper().eval(BASECELLEDITOR_VALUE, null);
	}

	protected void setBasecelleditorValue(java.lang.String basecelleditorValue) {
		getStateHelper().put(BASECELLEDITOR_VALUE, basecelleditorValue);
	}
