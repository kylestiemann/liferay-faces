...
public abstract class DataTableSelectionRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, DataTableSelection dataTableSelection) throws IOException {
		...
		responseWriter.startElement("script", dataTableSelection);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-datatableselection',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var dataTableSelection = new Y.DataTableSelection");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(dataTableSelection.getActiveCell() != null)
		{
			...
			responseWriter.write("activeCell: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dataTableSelection.getActiveCell().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(dataTableSelection.getActiveCoord() != null)
		{
			...
			responseWriter.write("activeCoord: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dataTableSelection.getActiveCoord().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(dataTableSelection.getActiveRow() != null)
		{
			...
			responseWriter.write("activeRow: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dataTableSelection.getActiveRow().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(dataTableSelection.getSelection() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dataTableSelection.getSelection().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(dataTableSelection.getTabIndex() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dataTableSelection.getTabIndex().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
