...
public abstract class ToggleButtonRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, ToggleButton toggleButton) throws IOException {
		...
		responseWriter.startElement("script", toggleButton);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-togglebutton',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var toggleButton = new Y.ToggleButton");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(toggleButton.getCssClass() != null)
		{
			...
			responseWriter.write(toggleButton.getCssClass().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(toggleButton.getIcon() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(toggleButton.getIcon().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(toggleButton.getIconAlign() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(toggleButton.getIconAlign().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(toggleButton.getIconElement() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(toggleButton.getIconElement().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(toggleButton.getPrimary() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(toggleButton.getPrimary().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
