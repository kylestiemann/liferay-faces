...
public abstract class CharCounterRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, CharCounter charCounter) throws IOException {
		...
		responseWriter.startElement("script", charCounter);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-charcounter',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var charCounter = new Y.CharCounter");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(charCounter.getCounter() != null)
		{
			...
			responseWriter.write("counter: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(charCounter.getCounter().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(charCounter.getInput() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(charCounter.getInput().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(charCounter.getMaxLength() != null)
		{
			...
			responseWriter.write("maxLength: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(charCounter.getMaxLength().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
