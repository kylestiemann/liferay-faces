...
public abstract class DatePickerDelegateRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, DatePickerDelegate datePickerDelegate) throws IOException {
		...
		responseWriter.startElement("script", datePickerDelegate);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-datepickerdelegate',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var datePickerDelegate = new Y.DatePickerDelegate");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(datePickerDelegate.getActiveInput() != null)
		{
			...
			responseWriter.write(datePickerDelegate.getActiveInput().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(datePickerDelegate.getContainer() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerDelegate.getContainer().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerDelegate.getContent() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerDelegate.getContent().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerDelegate.getDateSeparator() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerDelegate.getDateSeparator().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerDelegate.getMask() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerDelegate.getMask().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerDelegate.getValueExtractor() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerDelegate.getValueExtractor().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerDelegate.getValueFormatter() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerDelegate.getValueFormatter().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
