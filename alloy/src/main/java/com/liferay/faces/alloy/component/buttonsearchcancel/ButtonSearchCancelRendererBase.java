...
public abstract class ButtonSearchCancelRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, ButtonSearchCancel buttonSearchCancel) throws IOException {
		...
		responseWriter.startElement("script", buttonSearchCancel);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-buttonsearchcancel',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var buttonSearchCancel = new Y.ButtonSearchCancel");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(buttonSearchCancel.getContainer() != null)
		{
			...
			responseWriter.write(buttonSearchCancel.getContainer().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(buttonSearchCancel.getGutter() != null)
		{
			...
			responseWriter.write("gutter: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(buttonSearchCancel.getGutter().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(buttonSearchCancel.getIconClass() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(buttonSearchCancel.getIconClass().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(buttonSearchCancel.getTrigger() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(buttonSearchCancel.getTrigger().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(buttonSearchCancel.getZIndex() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(buttonSearchCancel.getZIndex().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
