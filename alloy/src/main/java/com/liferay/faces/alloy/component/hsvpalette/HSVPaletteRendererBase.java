...
public abstract class HSVPaletteRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, HSVPalette hSVPalette) throws IOException {
		...
		responseWriter.startElement("script", hSVPalette);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-hsvpalette',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var hSVPalette = new Y.HSVPalette");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(hSVPalette.getControls() != null)
		{
			...
			responseWriter.write(hSVPalette.getControls().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(hSVPalette.getFieldValidator() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVPalette.getFieldValidator().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(hSVPalette.getSelected() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVPalette.getSelected().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(hSVPalette.getStrings() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVPalette.getStrings().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
