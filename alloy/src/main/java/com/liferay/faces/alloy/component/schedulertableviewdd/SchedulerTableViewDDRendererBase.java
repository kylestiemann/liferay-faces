...
public abstract class SchedulerTableViewDDRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, SchedulerTableViewDD schedulerTableViewDD) throws IOException {
		...
		responseWriter.startElement("script", schedulerTableViewDD);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-schedulertableviewdd',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var schedulerTableViewDD = new Y.SchedulerTableViewDD");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(schedulerTableViewDD.getDelegateConfig() != null)
		{
			...
			responseWriter.write(schedulerTableViewDD.getDelegateConfig().toString());
			responseWriter.write(StringPool.APOSTROPHE);
