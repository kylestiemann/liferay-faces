...
public abstract class ImageCropperBase extends javax.faces.component.UIPanel {
	...
	public static final String PRESERVE_RATIO = "preserveRatio";
	...
	public static final String AFTER_CROP_HEIGHT_CHANGE = "afterCropHeightChange";
	public static final String AFTER_CROP_WIDTH_CHANGE = "afterCropWidthChange";
	...
	public static final String AFTER_MIN_HEIGHT_CHANGE = "afterMinHeightChange";
	public static final String AFTER_MIN_WIDTH_CHANGE = "afterMinWidthChange";
	public static final String AFTER_MOVABLE_CHANGE = "afterMovableChange";
	public static final String AFTER_PRESERVE_RATIO_CHANGE = "afterPreserveRatioChange";
	public static final String AFTER_REGION_CHANGE = "afterRegionChange";
	...
	public static final String ON_CROP_HEIGHT_CHANGE = "onCropHeightChange";
	public static final String ON_CROP_WIDTH_CHANGE = "onCropWidthChange";
	...
	public static final String ON_MIN_HEIGHT_CHANGE = "onMinHeightChange";
	public static final String ON_MIN_WIDTH_CHANGE = "onMinWidthChange";
	public static final String ON_MOVABLE_CHANGE = "onMovableChange";
	public static final String ON_PRESERVE_RATIO_CHANGE = "onPreserveRatioChange";
