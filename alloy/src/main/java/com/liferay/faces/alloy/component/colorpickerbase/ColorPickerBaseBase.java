 ...
 * @generated
 */
public abstract class ColorPickerBaseBase extends javax.faces.component.UIPanel {

	private static final String COLORPICKERBASE_BODY_CONTENT = "colorpickerbaseBodyContent";
	...
	protected java.lang.String getColorpickerbaseBodyContent() {
		return (java.lang.String) getStateHelper().eval(COLORPICKERBASE_BODY_CONTENT, null);
	}

	protected void setColorpickerbaseBodyContent(java.lang.String colorpickerbaseBodyContent) {
		getStateHelper().put(COLORPICKERBASE_BODY_CONTENT, colorpickerbaseBodyContent);
	}
