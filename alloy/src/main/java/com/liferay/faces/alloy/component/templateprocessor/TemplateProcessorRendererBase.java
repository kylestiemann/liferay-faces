...
public abstract class TemplateProcessorRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, TemplateProcessor templateProcessor) throws IOException {
		...
		responseWriter.startElement("script", templateProcessor);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-templateprocessor',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var templateProcessor = new Y.TemplateProcessor");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(templateProcessor.getDirectives() != null)
		{
			...
			responseWriter.write(templateProcessor.getDirectives().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(templateProcessor.getHost() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(templateProcessor.getHost().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(templateProcessor.getVariables() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(templateProcessor.getVariables().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
