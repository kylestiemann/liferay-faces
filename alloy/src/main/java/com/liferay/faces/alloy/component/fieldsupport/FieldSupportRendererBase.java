...
public abstract class FieldSupportRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, FieldSupport fieldSupport) throws IOException {
		...
		responseWriter.startElement("script", fieldSupport);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-fieldsupport',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var fieldSupport = new Y.FieldSupport");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(fieldSupport.getFields() != null)
		{
			...
			responseWriter.write(fieldSupport.getFields().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(fieldSupport.getMaxFields() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(fieldSupport.getMaxFields().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
