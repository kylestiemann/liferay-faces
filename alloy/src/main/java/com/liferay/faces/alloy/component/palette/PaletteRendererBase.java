...
public abstract class PaletteRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, Palette palette) throws IOException {
		...
		responseWriter.startElement("script", palette);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-palette',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var palette = new Y.Palette");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(palette.getColumns() != null)
		{
			...
			responseWriter.write(palette.getColumns().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(palette.getContainerNode() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(palette.getContainerNode().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(palette.getFormatter() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(palette.getFormatter().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(palette.getItems() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(palette.getItems().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(palette.getSelected() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(palette.getSelected().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(palette.getToggleSelection() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(palette.getToggleSelection().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
