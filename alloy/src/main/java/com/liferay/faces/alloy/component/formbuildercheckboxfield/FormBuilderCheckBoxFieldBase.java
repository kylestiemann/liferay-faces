 ...
 * @generated
 */
public abstract class FormBuilderCheckBoxFieldBase extends javax.faces.component.UIPanel {
	...
	private static final String FORMBUILDERCHECKBOXFIELD_ID = "formbuildercheckboxfieldId";
	...
	private static final String FORMBUILDERCHECKBOXFIELD_PARENT = "formbuildercheckboxfieldParent";
	...
	protected java.lang.Boolean getPredefinedValue() {
		return (java.lang.Boolean) getStateHelper().eval(PREDEFINED_VALUE, null);
	}

	protected void setPredefinedValue(java.lang.Boolean predefinedValue) {
