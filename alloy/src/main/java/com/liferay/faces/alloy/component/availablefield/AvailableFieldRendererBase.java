...
public abstract class AvailableFieldRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, AvailableField availableField) throws IOException {
		...
		responseWriter.startElement("script", availableField);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-availablefield',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var availableField = new Y.AvailableField");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(availableField.getDraggable() != null)
		{
			...
			responseWriter.write(availableField.getDraggable().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(availableField.getIconClass() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(availableField.getIconClass().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(availableField.getAvailablefieldId() != null)
		{
			...
			responseWriter.write("availablefieldId: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(availableField.getAvailablefieldId().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(availableField.getLabel() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(availableField.getLabel().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(availableField.getNode() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(availableField.getNode().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(availableField.getType() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(availableField.getType().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
