...
public abstract class TogglerDelegateRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, TogglerDelegate togglerDelegate) throws IOException {
		...
		responseWriter.startElement("script", togglerDelegate);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-togglerdelegate',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var togglerDelegate = new Y.TogglerDelegate");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(togglerDelegate.getAnimated() != null)
		{
			...
			responseWriter.write("animated: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getAnimated().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(togglerDelegate.getCloseAllOnExpand() != null)
		{
			...
			responseWriter.write("closeAllOnExpand: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getCloseAllOnExpand().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(togglerDelegate.getContainer() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getContainer().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(togglerDelegate.getContent() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getContent().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(togglerDelegate.getExpanded() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getExpanded().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(togglerDelegate.getHeader() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getHeader().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(togglerDelegate.getTransition() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(togglerDelegate.getTransition().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
