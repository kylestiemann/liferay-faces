...
public abstract class DatePickerBaseRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, DatePickerBase datePickerBase) throws IOException {
		...
		responseWriter.startElement("script", datePickerBase);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-datepickerbase',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var datePickerBase = new Y.DatePickerBase");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(datePickerBase.getAutoHide() != null)
		{
			...
			responseWriter.write(datePickerBase.getAutoHide().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(datePickerBase.getCalendar() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerBase.getCalendar().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerBase.getPanes() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerBase.getPanes().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
