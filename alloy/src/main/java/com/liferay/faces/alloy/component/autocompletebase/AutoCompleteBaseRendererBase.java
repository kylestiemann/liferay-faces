...
public abstract class AutoCompleteBaseRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, AutoCompleteBase autoCompleteBase) throws IOException {
		...
		responseWriter.startElement("script", autoCompleteBase);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-autocompletebase',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var autoCompleteBase = new Y.AutoCompleteBase");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(autoCompleteBase.getFillMode() != null)
		{
			...
			responseWriter.write("fillMode: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(autoCompleteBase.getFillMode().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(autoCompleteBase.getFilters() != null)
		{
			...
			responseWriter.write("filters: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(autoCompleteBase.getFilters().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(autoCompleteBase.getProcessor() != null)
		{
			...
			responseWriter.write("processor: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(autoCompleteBase.getProcessor().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(autoCompleteBase.getShowListKey() != null)
		{
			...
			responseWriter.write("showListKey: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(autoCompleteBase.getShowListKey().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(autoCompleteBase.getSorters() != null)
		{
			...
			responseWriter.write("sorters: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(autoCompleteBase.getSorters().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
