 ...
 */
public abstract class RadioCellEditorRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, RadioCellEditor radioCellEditor) throws IOException {
		...
		responseWriter.startElement("script", radioCellEditor);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-radiocelleditor',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var radioCellEditor = new Y.RadioCellEditor");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
