 ...
 * @generated
 */
public abstract class TreeNodeCheckBase extends javax.faces.component.UIPanel {
	...
	private static final String CHECK_CONTAINER_EL = "checkContainerEl";
	private static final String CHECK_EL = "checkEl";
	private static final String CHECK_NAME = "checkName";
	private static final String CHECKED = "checked";
	private static final String TREENODECHECK_CHILDREN = "treenodecheckChildren";
	...
	private static final String TREENODECHECK_ID = "treenodecheckId";
	...
	private static final String AFTER_CHECK_CONTAINER_EL_CHANGE = "afterCheckContainerElChange";
	private static final String AFTER_CHECK_EL_CHANGE = "afterCheckElChange";
	private static final String AFTER_CHECK_NAME_CHANGE = "afterCheckNameChange";
	private static final String AFTER_CHECKED_CHANGE = "afterCheckedChange";
	...
	private static final String ON_CHECK_CONTAINER_EL_CHANGE = "onCheckContainerElChange";
	private static final String ON_CHECK_EL_CHANGE = "onCheckElChange";
	private static final String ON_CHECK_NAME_CHANGE = "onCheckNameChange";
	...
	protected java.lang.String getCheckContainerEl() {
		return (java.lang.String) getStateHelper().eval(CHECK_CONTAINER_EL, null);
	}

	protected void setCheckContainerEl(java.lang.String checkContainerEl) {
		getStateHelper().put(CHECK_CONTAINER_EL, checkContainerEl);
	}

	protected java.lang.String getCheckEl() {
		return (java.lang.String) getStateHelper().eval(CHECK_EL, null);
	}

	protected void setCheckEl(java.lang.String checkEl) {
		getStateHelper().put(CHECK_EL, checkEl);
	}

	protected java.lang.String getCheckName() {
		return (java.lang.String) getStateHelper().eval(CHECK_NAME, null);
	}

	protected void setCheckName(java.lang.String checkName) {
		getStateHelper().put(CHECK_NAME, checkName);
	}

	protected java.lang.Boolean getChecked() {
		return (java.lang.Boolean) getStateHelper().eval(CHECKED, null);
	}

	protected void setChecked(java.lang.Boolean checked) {
		getStateHelper().put(CHECKED, checked);
	}

	protected java.lang.Object getTreenodecheckChildren() {
		return (java.lang.Object) getStateHelper().eval(TREENODECHECK_CHILDREN, null);
	}

	protected void setTreenodecheckChildren(java.lang.Object treenodecheckChildren) {
	...
	protected java.lang.String getTreenodecheckId() {
		return (java.lang.String) getStateHelper().eval(TREENODECHECK_ID, null);
	}

	protected void setTreenodecheckId(java.lang.String treenodecheckId) {
	...
	protected java.lang.String getAfterCheckContainerElChange() {
		return (java.lang.String) getStateHelper().eval(AFTER_CHECK_CONTAINER_EL_CHANGE, null);
	}

	protected void setAfterCheckContainerElChange(java.lang.String afterCheckContainerElChange) {
		getStateHelper().put(AFTER_CHECK_CONTAINER_EL_CHANGE, afterCheckContainerElChange);
	}

	protected java.lang.String getAfterCheckElChange() {
		return (java.lang.String) getStateHelper().eval(AFTER_CHECK_EL_CHANGE, null);
	}

	protected void setAfterCheckElChange(java.lang.String afterCheckElChange) {
		getStateHelper().put(AFTER_CHECK_EL_CHANGE, afterCheckElChange);
	}

	protected java.lang.String getAfterCheckNameChange() {
		return (java.lang.String) getStateHelper().eval(AFTER_CHECK_NAME_CHANGE, null);
	}

	protected void setAfterCheckNameChange(java.lang.String afterCheckNameChange) {
		getStateHelper().put(AFTER_CHECK_NAME_CHANGE, afterCheckNameChange);
	}

	protected java.lang.String getAfterCheckedChange() {
		return (java.lang.String) getStateHelper().eval(AFTER_CHECKED_CHANGE, null);
	}

	protected void setAfterCheckedChange(java.lang.String afterCheckedChange) {
	...
	protected java.lang.String getOnCheckContainerElChange() {
		return (java.lang.String) getStateHelper().eval(ON_CHECK_CONTAINER_EL_CHANGE, null);
	}

	protected void setOnCheckContainerElChange(java.lang.String onCheckContainerElChange) {
		getStateHelper().put(ON_CHECK_CONTAINER_EL_CHANGE, onCheckContainerElChange);
	}

	protected java.lang.String getOnCheckElChange() {
		return (java.lang.String) getStateHelper().eval(ON_CHECK_EL_CHANGE, null);
	}

	protected void setOnCheckElChange(java.lang.String onCheckElChange) {
		getStateHelper().put(ON_CHECK_EL_CHANGE, onCheckElChange);
	}

	protected java.lang.String getOnCheckNameChange() {
		return (java.lang.String) getStateHelper().eval(ON_CHECK_NAME_CHANGE, null);
	}

	protected void setOnCheckNameChange(java.lang.String onCheckNameChange) {
		getStateHelper().put(ON_CHECK_NAME_CHANGE, onCheckNameChange);
	}

	protected java.lang.String getOnCheckedChange() {
		return (java.lang.String) getStateHelper().eval(ON_CHECKED_CHANGE, null);
	}

	protected void setOnCheckedChange(java.lang.String onCheckedChange) {
