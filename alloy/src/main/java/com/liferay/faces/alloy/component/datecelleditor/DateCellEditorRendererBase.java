...
public abstract class DateCellEditorRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, DateCellEditor dateCellEditor) throws IOException {
		...
		responseWriter.startElement("script", dateCellEditor);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-datecelleditor',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var dateCellEditor = new Y.DateCellEditor");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(dateCellEditor.getDatecelleditorBodyContent() != null)
		{
			...
			responseWriter.write("datecelleditorBodyContent: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dateCellEditor.getDatecelleditorBodyContent().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(dateCellEditor.getCalendar() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dateCellEditor.getCalendar().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(dateCellEditor.getDateFormat() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dateCellEditor.getDateFormat().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(dateCellEditor.getInputFormatter() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dateCellEditor.getInputFormatter().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(dateCellEditor.getOutputFormatter() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(dateCellEditor.getOutputFormatter().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
