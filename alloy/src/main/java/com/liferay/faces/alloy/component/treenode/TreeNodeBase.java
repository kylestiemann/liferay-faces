...
public abstract class TreeNodeBase extends javax.faces.component.UIPanel {
	...
	private static final String TREENODE_CHILDREN = "treenodeChildren";
	...
	private static final String TREENODE_ID = "treenodeId";
	...
	protected java.lang.Object getTreenodeChildren() {
		return (java.lang.Object) getStateHelper().eval(TREENODE_CHILDREN, null);
	}

	protected void setTreenodeChildren(java.lang.Object treenodeChildren) {
	...
	protected java.lang.String getTreenodeId() {
		return (java.lang.String) getStateHelper().eval(TREENODE_ID, null);
	}

	protected void setTreenodeId(java.lang.String treenodeId) {
