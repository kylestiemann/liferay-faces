...
public abstract class HSVAPaletteRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, HSVAPalette hSVAPalette) throws IOException {
		...
		responseWriter.startElement("script", hSVAPalette);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-hsvapalette',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var hSVAPalette = new Y.HSVAPalette");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(hSVAPalette.getControls() != null)
		{
			...
			responseWriter.write("controls: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVAPalette.getControls().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(hSVAPalette.getFieldValidator() != null)
		{
			...
			responseWriter.write("fieldValidator: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVAPalette.getFieldValidator().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(hSVAPalette.getSelected() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVAPalette.getSelected().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(hSVAPalette.getStrings() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(hSVAPalette.getStrings().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
