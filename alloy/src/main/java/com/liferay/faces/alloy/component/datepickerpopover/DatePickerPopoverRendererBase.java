...
public abstract class DatePickerPopoverRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, DatePickerPopover datePickerPopover) throws IOException {
		...
		responseWriter.startElement("script", datePickerPopover);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-datepickerpopover',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var datePickerPopover = new Y.DatePickerPopover");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(datePickerPopover.getAutoHide() != null)
		{
			...
			responseWriter.write(datePickerPopover.getAutoHide().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(datePickerPopover.getPopover() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerPopover.getPopover().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(datePickerPopover.getPopoverCssClass() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(datePickerPopover.getPopoverCssClass().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
