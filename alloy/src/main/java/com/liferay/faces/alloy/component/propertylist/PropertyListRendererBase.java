...
public abstract class PropertyListRendererBase extends AUIRenderer {
	...
	protected void encodeJavaScript(FacesContext facesContext, PropertyList propertyList) throws IOException {
		...
		responseWriter.startElement("script", propertyList);
		...
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("'aui-propertylist',");
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("function(Y) ");
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		responseWriter.write("var propertyList = new Y.PropertyList");
		responseWriter.write(StringPool.OPEN_PARENTHESIS);
		responseWriter.write(StringPool.OPEN_CURLY_BRACE);
		responseWriter.write(StringPool.NEW_LINE);
		...
		if(propertyList.getColumns() != null)
		{
			...
			responseWriter.write(propertyList.getColumns().toString());
			responseWriter.write(StringPool.APOSTROPHE);
		...
		if(propertyList.getEditEvent() != null)
		{
			...
			responseWriter.write("editEvent: ");
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(propertyList.getEditEvent().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(propertyList.getScrollable() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(propertyList.getScrollable().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(propertyList.getStrings() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(propertyList.getStrings().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
		...
		if(propertyList.getWidth() != null)
		{
			...
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(propertyList.getWidth().toString());
			responseWriter.write(StringPool.APOSTROPHE);
			responseWriter.write(StringPool.COMMA);
			responseWriter.write(StringPool.NEW_LINE);
		}
