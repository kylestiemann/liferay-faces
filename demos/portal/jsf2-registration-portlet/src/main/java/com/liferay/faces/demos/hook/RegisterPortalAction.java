 ...
 * <p>
 * This is a portal startup action that will wrap the out-of-the-box Liferay PortalImpl instance with a wrapped
 ...
 * to create a Liferay EXT Plugin that simply extends the PortalImpl class and overrides the
 * {@link Portal#getCreateAccountURL(javax.servlet.http.HttpServletRequest, com.liferay.portal.theme.ThemeDisplay)}
 * method. The override would need to take place during portal startup by overriding the bean with the ext-spring.xml
 * file. For more information, see {@link http
 * ://www.liferay.com/documentation/liferay-portal/6.1/development/-/ai/developing-an-ext-plug-4}.
 * </p>
 *
 * @author Neil Griffin
 */
public class RegisterPortalAction extends SimpleAction {
	...
	public void run(String[] companyIds) throws ActionException {
		...
		try {
			...
			portal =
				(Portal) Proxy.newProxyInstance(classLoader, new Class[] { Portal.class }, new PortalHookImpl(portal));
		}
		catch (Exception e) {
			logger.error(e);
		}
