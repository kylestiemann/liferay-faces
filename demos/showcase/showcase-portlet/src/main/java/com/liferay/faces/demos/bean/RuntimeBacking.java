...
public class RuntimeBacking {
	...
	public void postConstruct() {
		...
		try {
			...
			JournalArticle article1 =
				WebContentUtil.getArticle(companyId, userId, groupId, folderId, locale, "Liferay Portal",
			...
			JournalArticle article2 =
				WebContentUtil.getArticle(companyId, userId, groupId, folderId, locale, "Liferay Faces",
