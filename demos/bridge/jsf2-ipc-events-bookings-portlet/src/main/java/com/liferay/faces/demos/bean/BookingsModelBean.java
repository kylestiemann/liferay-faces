 ...
 * phase of the JSF lifecycle to be executed. Note that this class has to be {@link SessionScoped} instead of
 * {@link ViewScoped} because the {@link Customer} received in the {@link CustomerSelectedEventHandler} (which is
 * injected into this bean) has to survive the navigation from the noCustomerSelected.xhtml view to the customers.xhtml
 * view due to the navigation-rule in the WEB-INF/faces-config.xml descriptor. Also, it needs to be
 * {@link SessionScoped} instead of {@link RequestScoped} because otherwise the bookings form data submitted in
 * customers.xhtml won't have a correctly-sized List&lt;Booking&gt; for the Faces APPLY_REQUEST_VALUES phase to postback
 * into.
 *
 * @author Neil Griffin
 */
