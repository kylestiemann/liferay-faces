 ...
 * multi-threaded environment. It starts up 10,000 threads, each of which attempts to create a
 * {@link LiferaySharedPageTop} instance that parses an XML document and removes duplicate link and script elements.
 * Note that not all of the threads have a chance to terminate gracefully before the JVM terminates, but that's OK.
 *
 * @author Neil Griffin
 */
public class LiferaySharedPageTopTest {
	...
	static {
		...
		buf.append("<script src=\"http://localhost:8080/web/guest/double-pf?p_p_id=1_WAR_primefaces3portlet_INSTANCE_lagDN0HOEH1J&amp;p_p_lifecycle=2&amp;p_p_state=normal&amp;p_p_mode=view&amp;p_p_cacheability=cacheLevelPage&amp;p_p_col_id=column-1&amp;p_p_col_count=1&amp;_1_WAR_primefaces3portlet_INSTANCE_lagDN0HOEH1J_javax.faces.resource=jquery%2Fjquery.js&amp;_1_WAR_primefaces3portlet_INSTANCE_lagDN0HOEH1J_ln=primefaces\" type=\"text/javascript\"></script>");
