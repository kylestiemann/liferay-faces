 ...
 * inspired by the factory pattern found in the JSF API like {@link javax.faces.context.FacesContextFactory} and
 * {@link javax.faces.context.ExternalContextFactory}. By implementing the {@link javax.faces.FacesWrapper} interface,
 * the class provides implementations with the opportunity to wrap another factory (participate in a
...
public abstract class ContextMapFactory implements FacesWrapper<ContextMapFactory> {
	...
	/**
	 * Returns a {@link Map} of application-scoped attributes stored in the underlying
