...
/**
 * This interface represents a JSF View from the perspective of how it is mapped to the
...
public interface FacesView {
	 ...
	 * {@link Bridge#NONFACES_TARGET_PATH_PARAMETER}, {@link Bridge#PORTLET_SECURE_PARAMETER},
	 * {@link Bridge#PORTLET_WINDOWSTATE_PARAMETER}, {@link Bridge#FACES_VIEW_ID_PARAMETER}, or
	 * {@link Bridge#FACES_VIEW_PATH_PARAMETER}. Note that "navigation" does not refer to JSF navigation-rules, but
	 * rather changes in {@link PortletMode}, {@link WindowState}, etc. It could also contain user-define name=value
	 * parameters specified in a {@link Bridge#VIEW_ID} request attribute.
	 */
