...
/**
 * This class is a portlet-specific implementation of the Faces Application. Its purpose is to override the
 * {@link #createComponent(String)} and {@link #getResourceHandler()} methods so that additional portlet-specific
 * instances can be introduced into the Faces lifecycle. Note that instances of this class are generated by the custom
 * {@link ApplicationFactoryImpl}.
 *
 * @author Neil Griffin
 */
public class ApplicationImpl extends ApplicationCompatImpl {
	...
	/**
	 * This method provides the ability to supply an instance of the bridge API's
	 * {@link PortletNamingContainerUIViewRoot} class which properly handles namespacing of "id" attributes for
	 * portlets.
	 *
							...
							if (portletRequest != null) {
								...
								if (!(wrappableNavigationHandler instanceof BridgeNavigationHandlerImpl)) {
									BridgeNavigationHandler bridgeNavigationHandler =
										new BridgeNavigationHandlerImpl(wrappableNavigationHandler);
