 ...
 * {@link BridgeRequestScope}. It is inspired by the factory pattern found in the JSF API like
...
public abstract class BridgeRequestScopeFactory implements FacesWrapper<BridgeRequestScopeFactory> {
	...
	public abstract BridgeRequestScope getBridgeRequestScope(PortletRequest portletRequest,
