...
/**
 * <p>
 * Occasionally there is an incongruity (a mismatch) between the Portlet lifecycle and the JSF lifecycle with regard to
 * execution of methods on the {@link ExternalContext}. This class is designed to compensate for these incongruous
 * actions as much as possible.
 * </p>
 * <p>
 * Example: Sometimes the JSF implementation or a JSF {@link javax.faces.event.ActionListener} will call methods like
 ...
 * corresponding method. Technically the only time such a method could be called would be during the
 * {@link javax.portlet.PortletRequest#RESOURCE_PHASE} because the {@link javax.portlet.ResourceResponse} class has a
...
public abstract class IncongruityContext extends ExternalContext {
	 ...
	 * {@link ExternalContext} methods that were inappropriately called during the ACTION_PHASE or EVENT_PHASE.
	 *
