 ...
 */
public class Primefaces4 extends TesterBase {

	protected static final Logger logger = Logger.getLogger(Primefaces4.class.getName());
	...
	static final String url = baseUrl + webContext + "/prime4";
