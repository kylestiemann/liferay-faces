...
public class Richfaces4PortletTest extends TesterBase {
	...
	private static final String emailAddressFieldErrorXpath = "//input[contains(@id,':emailAddress')]/following-sibling::*[1]/child::node()[1]/child::node()[1]";
	...
	private static final String fileUploadChooserXpath = "//input[@type='file' and @class='rf-fu-inp']";
	...
	private static final String componentLibraryVersionXpath = "//*[contains(text(),'RichFaces ')]";
