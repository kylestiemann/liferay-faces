 ...
 */
public class Liferayfaces4 extends TesterBase {

	protected static final Logger logger = Logger.getLogger(Liferayfaces4.class.getName());
	...
	// <a class="dropdown-toggle direction-down max-display-items-15" href="javascript:;" id="_1_WAR_liferayfaces4portlet_INSTANCE_ABCD_kldx_menu" title="Options">
