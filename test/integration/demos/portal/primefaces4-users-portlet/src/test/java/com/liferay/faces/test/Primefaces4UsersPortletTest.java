...
public class Primefaces4UsersPortletTest extends TesterBase {
	...
	private static final String primefaces4UsersLinkTestSetupXpath = "//a[contains(@href,'primefaces4usersportlet')]";
	...
	@FindBy(xpath = primefaces4UsersLinkTestSetupXpath)
	private WebElement primefaces4UsersLinkTestSetup;
	...
	public void usersListView() throws Exception {
		...
		primefaces4UsersLinkTestSetup.click();
